(custom-set-variables
 ...
 '(erc-autojoin-channels-alist
   (quote
    (("localhost" "#VergeCurrency|News" "&bitlbee" "#kulupupitokipona#1" "#EsperantoAmeriko#1")
     ("freenode.net" "#fsf" "#searx" "#guix" "##latinitas" "##latin" "#emacs" "#hurd" "#guix"))))
 ...
 '(erc-track-exclude-types (quote ("JOIN" "KICK" "NICK" "PART" "333" "353")))
 '(eww-search-prefix "http://nosearch.nogroup.group/searx/?q=")
 '(gnus-asynchronous t)
 ...
 '(org-capture-templates
   (quote
    (("k" "koan" entry
      (file+headline "~/notes/cap/koans.org" "unsorted")
      "** %? %i %T ")
     ("d" "todo" entry
      (file+headline "~/notes/cap/todo.org" "unsorted")
      "** TODO %? %i %T ")
     ("p" "projects" entry
      (file+headline "~/notes/cap/projects.org" "unsorted")
      "** %? %i %T "))))
