...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#000000" :foreground "#aaaaaa" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight medium :height 321 :width normal :foundry "DIGITAL" :family "vt220"))))
 ...
 '(custom-button-unraised ((t (:foreground "#5555ff" :background "#aaaaaa" :inherit underline))))
 '(custom-group-tag ((t (:foreground "#aa00aa" :inherit bold))))
 '(custom-state ((t (:foreground "yellow"))))
 '(custom-variable-tag ((t (:foreground "#00aaaa" :inherit bold))))
 '(eat-term-bold ((t (:inherit ansi-color-bold))))
 '(error ((t (:inherit nil :background "#ff5555" :foreground "black"))))
 '(font-lock-builtin-face ((t (:foreground "#ffff55" :inherit modus-themes-bold))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "#5555ff"))))
 ...
 '(mode-line ((t (:box nil :foreground "#00aa00" :background "black" :inherit modus-themes-ui-variable-pitch))))
 '(mode-line-highlight ((t (:background "dark magenta" :foreground "#ffffff" :box nil))))
 '(mode-line-inactive ((t (:box nil :inverse-video nil :foreground "#555555" :background "black" :inherit modus-themes-ui-variable-pitch))))
