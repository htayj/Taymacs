...
#+BEGIN_SRC emacs-lisp
  (use-package exwm
    ...
    (require 'exwm-randr)
    (setq exwm-randr-workspace-output-plist '(0 "eDP1" 1 "eDP1" 2 "HDMI1"  3 "HDMI1"  4 "HDMI1"  5 "HDMI1"   ))
    (add-hook 'exwm-randr-screen-change-hook
              (lambda ()
                (start-process-shell-command
                 "xrandr" nil "xrandr --output HDMI1 --mode 1920x1080 --pos 0x0 --rotate normal --output eDP1 --primary --mode 1920x1080 --pos 1920x300 --rotate normal")))
    (exwm-randr-enable)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c l") 'daedreth/take-screenshot-region)
#+END_SRC
** byzanz record
...
** treesitter TODO: disable when upgrade to 29
#+BEGIN_SRC emacs-lisp
